...
\IEEEauthorblockA{
\begin{tabular}{cc}
\textbf{Pratik Kumar\textsuperscript{1}} & \textbf{Thakur Choudhary\textsuperscript{2}} \\
...
\texttt{pratik.kumar2024a@vitstudent.ac.in} & \texttt{thakur.choudhary2024@vitstudent.ac.in} \\
\\
\textbf{Shruti\textsuperscript{3}} & \textbf{Vidhi Agarwal\textsuperscript{4}} \\
Department of Electronics and Communication & Department of Electronics and Communication \\
Vellore Institute of Technology (VIT) & Vellore Institute of Technology (VIT) \\
Vellore, Tamil Nadu, India & Vellore, Tamil Nadu, India \\
\texttt{shruti.2024@vitstudent.ac.in} & \texttt{vidhi.agarwal2024@vitstudent.ac.in} \\
\\
\multicolumn{2}{c}{\textbf{Uday Krishan Khandelwal\textsuperscript{5}}} \\
\multicolumn{2}{c}{Department of Electronics and Communication} \\
